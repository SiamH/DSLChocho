 ...
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.myDsl.impl.NotEqualImpl#getVar1 <em>Var1</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.myDsl.impl.NotEqualImpl#getVar2 <em>Var2</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class NotEqualImpl extends TypesImpl implements NotEqual
{
  /**
  ...
  {
    return MyDslPackage.Literals.NOT_EQUAL;
  }
    ...
    if (var1 != null && var1.eIsProxy())
    {
      ...
      if (var1 != oldVar1)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, MyDslPackage.NOT_EQUAL__VAR1, oldVar1, var1));
      }
    }
    return var1;
  }
  ...
  public void setVar1(Variable newVar1)
  {
    ...
    var1 = newVar1;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.NOT_EQUAL__VAR1, oldVar1, var1));
  }
  ...
  public Variable getVar2()
  {
    if (var2 != null && var2.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, MyDslPackage.NOT_EQUAL__VAR2, oldVar2, var2));
      }
    }
    return var2;
  }
  ...
  public void setVar2(Variable newVar2)
  {
    ...
    var2 = newVar2;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.NOT_EQUAL__VAR2, oldVar2, var2));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case MyDslPackage.NOT_EQUAL__VAR1:
        if (resolve) return getVar1();
        return basicGetVar1();
      case MyDslPackage.NOT_EQUAL__VAR2:
