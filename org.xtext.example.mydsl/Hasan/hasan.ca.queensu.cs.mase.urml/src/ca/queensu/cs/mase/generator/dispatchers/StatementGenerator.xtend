...
class StatementGenerator {
	...
	def dispatch String state(ChooseStatement st) {
		var lvalue = st.^var;
		var str = ""
		str += "int i = " + ''' «st.expression.express»;'''
		str += "\n"
		str += "int result = 0;"
		str += "\n"
		str += "if(i>0){"
		str += "\n"
		str += "Random randomGenerator = new Random();"
		str += "\n"
		str += "result = randomGenerator.nextInt(i);"
		str += "\n"
		str += "}"
		str += "\n"
		str + '''_l_«lvalue.name» = '''+"result;" +"\n"
	}
